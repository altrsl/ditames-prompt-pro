...
const NAV_ITEMS = [
  ...
  { label: "Leads",          to: "/admin/leads",       icon: MessageCircle,   permission: "view_audit_log" as const },
  { label: "Contatos",       to: "/admin/contacts",    icon: Mail,            permission: "view_audit_log" as const },
